...
@customElement("sf-twitter-share-button")
...
class SfLaunchBeforeGuide extends LitElement {
  ...
  render() {
    return html`
      <button class="twitter-share" @click=${this.onClick}>
        ${twitterSvg}
        <span class="twitter-share__label">
          <slot>Twitterでシェアする</slot>
        </span>
      </button>
    `;
  }
